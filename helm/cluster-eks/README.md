...
| `internal.nodePools.PATTERN.updateConfig` | **Update configuration of the nodegroup**|**Type:** `object`<br/>**Key pattern:**<br/>`PATTERN`=`^[a-z0-9][-a-z0-9]{3,18}[a-z0-9]$`<br/>|
...
| `global.nodePools.PATTERN.updateConfig` | **Update configuration of the nodegroup**|**Type:** `object`<br/>**Key pattern:**<br/>`PATTERN`=`^[a-z0-9][-a-z0-9]{3,18}[a-z0-9]$`<br/>|
