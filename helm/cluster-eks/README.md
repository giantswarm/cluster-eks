...
| `global.controlPlane.encryptionConfig.resources` | **Resources** - K8s resources to encrypt. Default to secrets if not specified.|**Type:** `array`<br/>|
| `global.controlPlane.encryptionConfig.resources[*]` | **Resource** - K8s resource to encrypt, for example `secrets`.|**Type:** `string`<br/>|
