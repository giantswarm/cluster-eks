...
| `global.providerSpecific.addons[*].conflictResolution` | **Conflict resolution** - Declare what should happen if there are parameter conflicts. Defaults to none.|**Type:** `[string]`<br/>**Default:** `"none"`|
